...
/**
 * <h3>Taken From:
 * https://www.javatips.net/api/bitcoinj-master/core/src/main/java/org/bitcoinj/core/Base58.java</h3>
...
public class Base58
{
     ...
     */
    public static byte[] decodeChecked(final String input)
    {
        final byte[] decoded = decode(input);
        if (decoded.length < 4)
        {
        ...
        final byte[] actualChecksum = Arrays.copyOfRange(CryptoUtils.SHA256(CryptoUtils.SHA256(data)), 0, 4);
